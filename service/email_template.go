...
func buildEmailFooter(logoURL, instagramURL, facebookURL, tiktokURL, websiteURL, supportEmail, footerNote, copyright string) string {
	...
	// Wave decoration (inline SVG, bottom-left purple accent)
	waveSVG := `<svg xmlns="http://www.w3.org/2000/svg" width="150" height="130" viewBox="0 0 150 130" style="display:block;"><path d="M0 130 L0 75 Q35 20 70 50 Q105 80 135 35 Q143 18 150 22 L150 130 Z" fill="#7c3aed" opacity="0.13"/><path d="M0 130 L0 95 Q40 60 75 75 Q110 90 140 65 L150 60 L150 130 Z" fill="#7c3aed" opacity="0.09"/></svg>`

	// Heart decoration (inline SVG, bottom-right purple card with heart)
	heartSVG := `<svg xmlns="http://www.w3.org/2000/svg" width="95" height="105" viewBox="0 0 95 105" style="display:block;margin-left:auto;"><rect x="12" y="18" width="66" height="66" rx="15" fill="#5b21b6" opacity="0.3"/><rect x="6" y="10" width="66" height="66" rx="15" fill="#7c3aed"/><path d="M39 56C39 56 20 44 20 31.5 20 24.5 25.5 19 32.5 19 36.5 19 39 21.5 39 21.5S41.5 19 45.5 19C52.5 19 58 24.5 58 31.5 58 44 39 56 39 56Z" fill="white"/><circle cx="80" cy="16" r="3.5" fill="#a78bfa"/><circle cx="87" cy="28" r="2" fill="#c4b5fd"/><circle cx="74" cy="8" r="2.5" fill="#ddd6fe"/><circle cx="90" cy="14" r="1.5" fill="#ede9fe"/></svg>`
...
<tr>
<td width="150" valign="bottom" style="padding:0;line-height:0;font-size:0;vertical-align:bottom;">%s</td>
...
<td width="95" valign="bottom" style="padding:0;line-height:0;font-size:0;vertical-align:bottom;">%s</td>
</tr>
</table>
</td></tr>`,
